...
import { GetConfig, SaveConfig, StartSync, StopSync, SelectDirectory, OpenDirectory, LocateFile, GetRemoteItems, StartOver, GetStartOverPaths, SetWorkspaceLocation, GetAppVersion } from '../wailsjs/go/main/App'
        ...
        <div v-else class="p-6 absolute inset-0 overflow-y-auto custom-scrollbar">
          <div class="space-y-6 pb-6">
            ...
            <div class="mt-4 text-center pb-2">
              <span class="text-[10px] font-mono text-slate-600">{{ appVersion.startsWith('v') ? appVersion : 'v' + appVersion }}</span>
            </div>
